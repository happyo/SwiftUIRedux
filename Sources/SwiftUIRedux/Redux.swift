...
public class Store<T: Feature>: ObservableObject, StoreProtocol {
    ...
    init(initialState: T.State, reducer: T.Reducer, middlewares: [AnyMiddleware<T>] = []) {
...
public class StoreFactory {
    static func createStore<FeatureType: Feature>() -> Store<FeatureType> {
        return Store(
